...
namespace Rivet {
  ...
  class MC_MARKUS13TEV : public Analysis {
...
#include "NLOHisto1D.cc"
  ...
  public:
    ...
    void init() {
       ...
       _h_pTbmin = bookNLOHisto1D("pTbmin", 400, 0., 800.);
       _h_pTbmax = bookNLOHisto1D("pTbmax", 400, 0., 800.);
       _h_pTmu = bookNLOHisto1D("pTmu", 400, 0., 800.);
       _h_etamu = bookNLOHisto1D("etamu", 50, -5, 5);
       _h_mll = bookNLOHisto1D("mll", 400, 0., 800.);
       _h_mlb = bookNLOHisto1D("mlb", 400, 0., 800.);
       _h_etdr = bookNLOHisto1D("etdr", 400, 0., 800.);
       _h_mt2 = bookNLOHisto1D("mt2", 400, 0., 800.);
...
scale(_h_pTb, factor);
  ...
  DECLARE_RIVET_PLUGIN(MC_MARKUS13TEV);
